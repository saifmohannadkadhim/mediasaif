...
st.markdown(
    f"""
    <div style='width: 100%; direction: rtl; text-align: left;'>
        <div style='direction: rtl style='display: flex; align-items: center; justify-content: flex-end; gap: 0;'>
            <img src='data:image/jpeg;base64,{logo_base64}' width='100' style='margin:0 '>
            <h2 style='margin: 0; padding: 0;'>📰 المولد الذكي للأخبار الإعلامية</h2>
        </div>
    </div>
    """,
    unsafe_allow_html=True
...
6. ذكر التاريخ  بصيغة سريانية (يوم – شهر سرياني – سنة)، كما ورد في المدخلات.
7.التاريخ يكون ضمن متن الخبر وليس في العنوان.

⚠️ ممنوع استخدام أي عناوين داخل النص مثل:
- عنوان الخبر:
- مقدمة الخبر:
- تفاصيل الخبر:
- ختام الخبر:
